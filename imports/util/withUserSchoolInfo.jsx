...
export default (withUserSchoolInfo = WrappedComponent => class withUserSchoolInfoHOC extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      showLogo: false,
  ...
  render() {
    return <WrappedComponent {...this.props} showLogo={this.state.showLogo} />;
  }
});

...
export const welcomeEMail = (user, verificationToken, passwd=null) => {
  ...
  <div class="header" style="width: 100%;">
    ...
    <div class="body" style="background-color: #ddd;">
      <div class="content" style="max-width: 300px;margin: auto;font-style: italic;">
        ...
        <a href=${verificationToken} style="width: 100%;height: 25px;background-color: green;border: none;color: white;padding: 15px 0px;text-align: center;display: inline-block;font-size: 19px;cursor: pointer;font-family: 'Zilla Slab', serif;font-style: italic;border-radius: 5px;text-decoration: none;">Confirm your email</a>
        ...
        <p class="mini" style="font-size: 14px;font-style: italic;margin-bottom: 0px;">If you do not remember signing up for this,<a href=${Meteor.absoluteUrl()+"unsubscribe"} style="text-decoration: none;">click here to unsubscribe.</a></p>

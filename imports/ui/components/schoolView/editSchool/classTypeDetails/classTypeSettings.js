...
export default (classTypeSettings = {
  mainPanelHeader: {
    ...
    notes:
      'Class Types are a group of one or more Class Times where similar or related material is taught to students, possibly grouped by age, skill level, or gender. If you separate classes by age, gender, skill level or material, separate Class Types should be created.',

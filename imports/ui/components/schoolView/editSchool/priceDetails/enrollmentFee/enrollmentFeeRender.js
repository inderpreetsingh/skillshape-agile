...
export default function () {
  ...
  return (
    <div className="class-price-details">
      ...
      <PanelHeader
        btnText="Add Enrollment Fee"
        title="Enrollment Fee Cost"
        caption=" If you add a Class Type to an enrollment fee, students will need to purchase the Enrollment Fee before they can purchase Per Class or Monthly packages for that Class Type, or sign in to that class."
        icon="assignment"
        onAddButtonClicked={() => {

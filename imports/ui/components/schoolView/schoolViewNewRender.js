...
import StripeIDealDialog from '/imports/ui/components/landing/components/dialogs/StripeIDealDialog';

const PackagesList = lazy(() => import('/imports/ui/components/landing/components/class/packages/PackagesList'));
const ClassTypeList = lazy(() => import('/imports/ui/components/landing/components/classType/classTypeList'));
const MediaDetails = lazy(() => import('/imports/ui/components/schoolView/editSchool/mediaDetails'));
const ManageMyCalendar = lazy(() => import('/imports/ui/components/users/manageMyCalendar/index'));
    ...
    <DocumentTitle title={this.props.routeParams.slug}>
      <Wrapper className="content">
        ...
        <StripeIDealDialog
          ...
          onModalClose={() => {
            this.setState({ stripeIDealDialog: false });
          }}
        ...
        <GiveReviewDialogBox
          ...
          reviewFor="school"
          title={this.getReviewTitle(schoolData.name)}
        ...
        <ConfirmationModal
          ...
          onSubmit={() => {
            this.requestPricingInfo(schoolData);
          }}
        ...
        <CustomModal
          ...
          message={
                successModal && `You are now owner of ${schoolData.name} Would you like to edit ?`
              }
        ...
        <div>
          <SchoolViewNewBanner
            ...
            bestPriceDetails={{
              monthly:
                  ...
                  && !isEmpty(this.state.bestPriceDetails.bestMonthlyPrice)
                    ? floor(this.state.bestPriceDetails.bestMonthlyPrice.avgRate)
                    : null,
              class:
                  this.state.bestPriceDetails
                  && !isEmpty(this.state.bestPriceDetails.bestClassPrice)
          ...
          <ReviewsWrapper>
            ...
            <ReviewsButtonWrapper marginTop={isEmpty(reviewsData) ? '64' : '0'}>
              {isEmpty(reviewsData) && (
              <Fragment>
                <Typography>You are the first one to write review for this school.</Typography>
                <br />
              </Fragment>
              )}
          ...
          <MyCalendarWrapper
            ref={(el) => {
              this.schoolCalendar = el;
            }}
          >
            <Element name="schedule-section">
              <Suspense fallback={<Loading />}>
                {loadComplete && <ManageMyCalendar schoolCalendar {...this.props} />}
              </Suspense>
            </Element>
          </MyCalendarWrapper>

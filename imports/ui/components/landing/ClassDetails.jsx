...
class ClassDetailsContainer extends Component {
  ...
  render() {
    ...
    if(isEmpty(classData) && isEmpty(instructorsData) && isEmpty(instructorsIds)){
      return (
        <NoPageFound/>
      );
    }
...
export default createContainer((props) => {
  ...
  const state  = get(props.location.state,'state',null);
  const dataProps = get(props.location.state,'props',null);
  if(state && dataProps){

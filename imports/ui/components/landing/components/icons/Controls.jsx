...
const Controls = (props) => (
  <ControlsWrapper>
  <SVGInline className={props.className} height={props.height} width={props.width} svg={`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 56 56" xml:space="preserve" width="512px" height="512px" >
    <g>

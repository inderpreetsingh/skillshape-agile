...
const IconWrapper = styled.div`
  ...
  background-color: ${helpers.danger};
  width: ${helpers.baseFontSize * 3}px;
  height: ${helpers.baseFontSize * 3}px;
`;

const Cart = (props) => (
  <IconWrapper>
    <SVGInline onClick={props.onClick} className={props.className} height={props.height} width={props.width}
    svg={`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 294.873 294.873" style="enable-background:new 0 0 294.873 294.873;" xml:space="preserve" width="512px" height="512px">
      <g style="transform: translateY(24px);">

...
InfoBox.prototype.panBox_ = function (disablePan) {
  ...
  if (!disablePan) {
    ...
    if (map instanceof google.maps.Map) { // Only pan if attached to map, not panorama
      ...
      const pixPosition = this.getProjection().fromLatLngToContainerPixel(this.position_);
...
InfoBox.prototype.draw = function () {
  ...
  const pixPosition = this.getProjection().fromLatLngToDivPixel(this.position_);

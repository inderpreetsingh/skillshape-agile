...
class ContactUsForm extends Component {
  ...
  checkErrorInField = inputName => this.state.errorInFields[inputName];
  ...
  handleSubmit = (e) => {
    ...
    if (this.props.onSubmitButtonClick) this.props.onSubmitButtonClick(fields);
  };
  ...
  _getFocussedClassName(inputName) {
    const { classes } = this.props;
    return this.checkErrorInField(inputName)
      ? classes.errorInputLabelFocused
  ...
  render() {
    ...
    return (
      <ContactUsFormWrapper fullWidth={fullWidth} width={width}>
        <FormHeader>
          <FormHeaderText>{headerText || 'Get in touch with us'}</FormHeaderText>
        </FormHeader>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl component="fieldset" required className={classes.formControl}>
                  ...
                  >
                    <FormControlLabel
                      value="feature"
                      control={<Radio classes={{ checked: classes.radioButtonChecked }} />}

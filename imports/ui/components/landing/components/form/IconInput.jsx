      ...
      <Fragment>
        {!props.skillShapeInput ? (
          <FormControl error={props.error} fullWidth aria-describedby="error-text">
            <InputLabel htmlFor={props.inputId} classes={{ root: props.classes.label }}>
              {props.labelText}
            </InputLabel>
            <Input
            ...
            <div
              className={
                this.state.inputFocused
                  ? `rw-multiselect rw-widget rw-state-focus ${props.classes.widgetRoot}`
                  : `rw-multiselect rw-widget ${props.classes.widgetRoot}`
              }
            >
              <div
                tabIndex="0"
                className={`rw-widget-input rw-widget-picker rw-widget-container ${
                  props.classes.widgetInput
                }`}
              >
                <div
                  style={{

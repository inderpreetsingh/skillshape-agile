...
const MemberExpanded = lazy(() => import('./MemberExpanded'));
...
const MembersList = (props) => {
  const expanded = props.viewType === 'instructorsView' && props.entityType === 'students';
  const type = props.entityType === 'students' ? 'student' : 'instructor';
  const studentsView = props.viewType === 'studentsView' && props.entityType === 'students';

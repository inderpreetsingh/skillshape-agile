...
import CardsList from '/imports/ui/components/landing/components/cards/CardsList';
import Footer from '/imports/ui/components/landing/components/footer/index';
import * as helpers from '/imports/ui/components/landing/components/jss/helpers';
import MapView from '/imports/ui/components/landing/components/map/mapView';
import Preloader from '/imports/ui/components/landing/components/Preloader';
import SuggestionFormWrapper from '/imports/ui/components/landing/components/schoolSuggestions/SuggestionFormWrapper';
...
class ClassTypeList extends Component {
  ...
  makeCategorization = ({ classTypeData = [], skillCategoryData }) => {
    const data = {};
    for (const skillCategoryObj of skillCategoryData) {
      data[skillCategoryObj.name] = [];
      for (const classTypeObj of classTypeData) {
        if (!isEmpty(classTypeObj.selectedSkillCategory)) {
          const index = findIndex(classTypeObj.selectedSkillCategory, {
...
export default createContainer((props) => {
  ...
  const isAllSubReady = classInterestSub
    && classInterestSub.ready()
    && reviewsSubscription

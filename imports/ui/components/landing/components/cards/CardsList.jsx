...
import ClassTypeCard from '/imports/ui/components/landing/components/cards/ClassTypeCard';
import * as helpers from '/imports/ui/components/landing/components/jss/helpers';
import CardStructure from '/imports/ui/components/landing/constants/structure/card';
...
const More = styled.div`
	...
	${helpers.flexCenter} margin-top: ${helpers.rhythmDiv * 3}px;
`;
...
class CardsList extends Component {
  ...
  seeMoreStatus = (cardsData, filters, name) => {
    const { skillCategoryClassLimit } = filters;
        ...
        <CardsListGridWrapper mapView={mapView}>
          ...
          <GridContainer>
            {cardsData.map((card) => {
              ...
              const { currentCardReviews } = ourReviewsData;

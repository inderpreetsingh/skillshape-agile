...
import ProfileImage, {
  SSAvatar,
} from '/imports/ui/components/landing/components/helpers/ProfileImage';
import {
  SubHeading,
  Text,
  ToggleVisibility,
} from '/imports/ui/components/landing/components/jss/sharedStyledComponents';
import { coverSrc } from '/imports/ui/components/landing/site-settings';
...
const ClassDataButtons = props => (
  <CDButtonsWrapper>
    ...
    <ButtonWrapper noMarginBottom>
      <SecondaryButton fullWidth label="Leave class" onClick={props.onLeaveClassButtonClick} />
    </ButtonWrapper>
  </CDButtonsWrapper>
);
    ...
    >
      ...
      <MuiThemeProvider theme={muiTheme}>
        <DialogTitleContainer>
          ...
          <DialogTitleWrapper>
            <SchoolName>
              {capitalizeString(schoolName || get(selectedSchoolData, 'name', 'schoolName'))}
            </SchoolName>
            <DialogTitleText>
              Edit membership for
              {capitalizeString(studentName)}
            </DialogTitleText>
          </DialogTitleWrapper>
          <IconButton
            color="primary"
                ...
                >
                  <ClassProfile>
                      ...
                      src={get(
                        ...
                        get(
                          ...
                          get(
                            selectedSchoolData,
                            'mainImage',
                            get(selectedSchoolData, 'mainImageMedium', ''),
                          ),
                        ),
                      )}
                    />
                    ...
                    <ClassNameWrapper>
                      <ClassName>
                        {' '}
                        {capitalizeString(get(classData, 'name', 'Test Class Type'))}
                        {' '}
                      </ClassName>
                      <ToggleVisibility show>
                        <ClassDataButtons
                          ...
                          onLeaveClassButtonClick={(e) => {
                            e.stopPropagation();
                            removeAll(
                              get(classData, 'classTimes', []),
                              get(classData, 'name', 'Test Class Type'),
                              classData._id,
                            );
                          }}
                ...
                <ExpansionPanelDetails classes={{ root: classes.expansionPanelDetails }}>
                  ...
                  <ClassTimesList>
                    {classData.classTimes.map((classTimeData, index) => {
                      ...
                      return (
                        <ClassTimesListItem key={index.toString()}>
                            ...
                            <ButtonWrapper noMarginBottom>
                              <FormGhostButton
                                ...
                                onClick={(e) => {
                                  ...
                                  removeFromCalendar({
                                    userId,
                                    classTimeId: classTimeData._id,
                                    classTypeName: get(classData, 'name', 'Test Class Type'),
                                    classTimeName: get(classTimeData, 'name', 'Class Time Name'),
                                  });
                                }}
                              />
                            </ButtonWrapper>

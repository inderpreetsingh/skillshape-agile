...
class PackageAddNew extends React.Component {
  ...
  render() {
    const {
      schoolId, data, currency, classTypeData, handleIsSavedState,
    } = this.props;
    ...
    return (
      <MuiThemeProvider theme={muiTheme}>
        ...
        >
          ...
          <DialogContent>
            What kind of package you want to create? Please Select the package that you want to add
            to this class time.
          </DialogContent>
          <DialogActions classes={{ root: this.props.classes.dialogActionsRoot }}>
            <ButtonWrapper>
              <FormGhostButton
                onClick={() => {
                  this.setState({ enrollmentFeeForm: true });
                }}
            ...
            <ButtonWrapper>
              <FormGhostButton
                onClick={() => {
                  this.setState({ classPackageForm: true });
                }}
                label="Class Package"
              />
            </ButtonWrapper>
            <ButtonWrapper>
              <FormGhostButton
                onClick={() => {
                  this.setState({ monthlyPackageForm: true });
                }}

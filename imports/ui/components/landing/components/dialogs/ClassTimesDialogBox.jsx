...
class ClassTimesDialogBox extends React.Component {
  ...
  componentDidMount() {
    ...
    setTimeout(() => {
      const divElement = $('#myScrollToElement').offset();
      const offset = divElement.top;
      ...
      >
        <MuiThemeProvider theme={muiTheme}>
          <MyScrollToElement id="myScrollToElement" ref={c => (this.myDiv = c)}>
            ...
            <DialogContent classes={{ root: classes.dialogContent }} style={{ overflow: 'hidden' }}>
                ...
                <ContentWrapper>
                  ...
                  <Grid container style={{ padding: '22px' }}>
                    <IconsWrapper>
                      <IconsRowWrapper>
                        <div
                          className={`${classes.iconWithDetailContainer} ${classes.bottomSpace}`}
                        >
                    ...
                    <Grid item xs={12}>
                      {ageMin && ageMax && (
                        <MetaInfo data={`  ${ageMin} to ${ageMax}`} title={'Age:' + ' '} />
                      )}
                      {gender && gender !== 'All' && (
                      ...
                      {experienceLevel && experienceLevel == 'All' ? (
                        ...
                        <MetaInfo data={`  ${experienceLevel}`} title={'Experience:  ' + ' '} />
                      )}
                    </Grid>
                    {desc && (
                      <MetaInfo data={`  ${desc}`} title="Description:" marginBottom={16} />
                    )}
                  </Grid>

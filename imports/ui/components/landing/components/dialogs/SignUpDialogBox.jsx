...
class SignUpDialogBox extends Component {
  ...
  render() {
    ...
    const { emailOption,robotOption,name,email } = this.state;
    console.log('render....');
    return(
    <Dialog
    ...
    >
      ...
      <DialogContent className={classes.dialogContent}>
        ...
        <InputWrapper>
          <IconInput labelText="Name" iconName="person" value={name} onChange={this.handleTextChange}/>
          <IconInput type="email" labelText="Email Address" value={email} iconName="email" onChange={this.handleTextChange}/>
        </InputWrapper>

        <PrimaryButton fullWidth label="Sign Up" onClick={onSignUpButtonClick}></PrimaryButton>

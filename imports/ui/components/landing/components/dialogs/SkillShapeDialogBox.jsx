...
class SkillShapeDialogBox extends Component {
  ...
  _getAffirmateButtonText = () => {
    const {
      type, defaultButtons,  affirmateBtnText,
    } = this.props;
    if (affirmateBtnText) {
  ...
  getActionButtons = () => {
    const { type, defaultButtons, RenderActions } = this.props;
    if (RenderActions) {
    ...
    if (type === 'alert' || type === 'success' || type === 'warning') {
  ...
  render() {
    const {
      title, content, type, classes, onModalClose, open,
    } = this.props;
    return (
      <MuiThemeProvider theme={muiTheme}>
        ...
        >
          ...
          <DialogContent classes={{ root: classes.dialogContent }}>
            <Content>
              {' '}
              {content || popUpBasicConfig[type].content}
              {' '}
            </Content>
          </DialogContent>

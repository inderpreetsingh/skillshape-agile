...
class ManageRequestsDialogBox extends Component {
  ...
  handleFormSubmit = (e) => {
    ...
    const {
      popUp, requestFor, schoolData, classTypeId,
    } = this.props;
    ...
    if (this.state.readyToSubmit) {
      if (!data.email) {
        ...
        popUp.appear(
          'alert',
          { title: 'Invalid Email', content: 'Please enter valid email address' },
          false,
        );
        e.stopPropagation();
      } else if (!data.name) {
  ...
  componentDidMount = () => {
    ...
    setTimeout(() => {
      const divElement = $('#manageDialog').offset();
                ...
                <form onSubmit={this.handleFormSubmit}>
                  ...
                  <ButtonWrapper>
                    {this.state.readyToSubmit ? (
                      ...
                      <button className="cancel-button increase-height" disabled>
...
export default withPopUp(withMobileDialog()(withStyles(styles)(ManageRequestsDialogBox)));

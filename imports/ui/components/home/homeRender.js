...
export default function () {
  const { mapView, isLoading, currentAddress } = this.state;
  ...
  return (
    <div className="content">
      <div className="container-fluid">
        ...
        <div className="row">
          <div className="col-sm-12 grid-map-wrap">
            <div className="col-sm-7 text-right p0 pull-right">
              <p className="dispInBlk text-center-xs dispBlk-xs">Choose View:</p>
              <button
                id="view_list"
        ...
        {mapView && (
          <MapView setSchoolIdFilter={this.setSchoolIdFilter} {...this.props} {...this.state} />
        )}

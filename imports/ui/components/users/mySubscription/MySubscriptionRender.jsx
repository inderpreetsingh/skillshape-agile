...
import { schoolLogo } from '/imports/ui/components/landing/site-settings';
...
const ContactSchool = props => (
  <ContactIcons>
    {props.phone && props.phone.length > 0 && (
      <IconButton classes={{ root: props.classes.contactIconButton }}>
...
const MySubscriptionRender = (props) => {
  const getSubsDataBasedOnSchool = (schoolId, purchaseData) => purchaseData.filter(sbsData => sbsData.schoolId === schoolId);
  ...
  const schoolName = get(selectedSchool, 'name', 'School');
  return (
    <Fragment>
      {privacySettings && (
        <PrivacySettings
              ...
              >
                ...
                >
                  ...
                  <ActionButtons
                    ...
                    onPrivacySettingsClick={() => {
                      onPrivacySettingsClick(true, school);
                    }}

  ...
  <DocumentTitle title={props.route.name}>
    <MainContainer>
      <MainContentWrapper className={props.classes.aboutUs}>
        ...
        <div style={{
          textAlign: 'center', padding: '100px 16px', position: 'absolute', top: 0, left: 0, bottom: 0, right: 0,
        }}
        >
      ...
      <MainContentWrapper className={props.classes.keepStudentEngaged}>
        ...
        <div style={{ margin: 'auto', zIndex: 1 }}>
          ...
          <Typography style={{ textAlign: 'center', color: '#fff' }}>SkillShape offers a few ways to keep your students engaged and excited.</Typography>
          <ul
            type="a"
            style={{
              margin: 'auto', marginTop: '24px', maxWidth: '743px', color: '#655454fc',
            }}
          >
            <li className={props.classes.typoText}>

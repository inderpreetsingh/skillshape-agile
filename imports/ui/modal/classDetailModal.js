							...
							<Grid container style={{border: '2px solid #ccc',marginTop: '16px'}}>
								...
								{ this.props.routeName !== "EmbedSchoolCalanderView" &&
								  <Grid container style={{padding: 8}}>
									<Grid item xs={6}>
									  <PrimaryButton fullWidth noMarginBottom  label="View Class Type" boxShadow noMarginBottom onClick={()=> this.goToClassTypePage(classType.name, eventData.classTypeId)} />
									</Grid>
									<Grid item xs={6}>
									  <PrimaryButton fullWidth noMarginBottom  label="View School" boxShadow noMarginBottom  onClick={()=> this.goToSchoolPage(school)}/>
									</Grid>
								  </Grid>
								}
							</Grid>

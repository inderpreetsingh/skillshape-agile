      ...
      <Route path="/" component={AdminLayout}>
        <Route
          ...
          getComponent={(nextState, cb) => {
            //set loading:true
            props.isLoading.show();
            import("/imports/ui/components/schoolUpload").then(SchoolUpload => {
              // set loading false
              props.isLoading.hide();
              cb(null, SchoolUpload.default);
            });
          }}
        />
        <Route
        ...
        <Route
          ...
          getComponent={(nextState, cb) => {
            //set loading:true
            props.isLoading.show();
            import("/imports/ui/components/manage-users").then(ManageUsers => {
              // set loading false
              props.isLoading.hide();
              cb(null, ManageUsers.default);
            });
          }}
        />
      </Route>
